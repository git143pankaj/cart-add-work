...
//alert($(this).data('image'));
        var str = '<div ><div class="pict"><img src="'+$(this).data('image')+'" style="float: left; width:30%; height:110px;" ></div><div class="rgt_cont"><h4 class="item_class">'+$(this).data('name')+'</h4><p><i class="fas fa-rupee-sign"></i>'+$(this).data('price')+'<span class="grey"><del><i class="fas fa-rupee-sign"></i>'+$(this).data('discount')+'</del></span><span class="grn">'+$(this).data('discount')+'%</span></p><div class="add-del-btn"><button type="button" class="altera decrescimo left" style="height:40px; width:15%;" data-id="'+$(this).data('id')+'">-</button><input type="text" style="width:20%;text-align:center; height:40px;"  id="'+$(this).data('id')+'_mid_num" value="0"/><button type="button" class=" add altera acrescimo left" style="height:40px; width:15%;" data-id="'+$(this).data('id')+'">+</button></div></div>';
  ...
  //$($input).attr("width","20%");
    if ($(this).hasClass('acrescimo'))
     $input.val(parseInt($input.val())+1);
       ...
       // $input.val(parseInt($input.val())+1);
       //$input.css({"width":"20%", "height":"40px"});
       //$(this).addClass('inpt_text').html();
    else if ($input.val()>=1)
       $input.val(parseInt($input.val())-1);
});
